...
#' @usage getChangeParams(files, base=NULL, margin=1, trim=0, high=NULL, tol=0.1, outfile=NULL, append=F)
...
#' shape_ex = getExampleData("shape_ex")
#' #get change parameters
#' params = getChangeParams((sample, trim=5, outfile="out.txt")
#'
getChangeParams = function(sample, base, margin, trim, high, tol, outfile, append){
